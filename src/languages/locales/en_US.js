export default {
  ...
  swap: {
    ...
    usdtUsdolProhibited: "Direct swap between USDT and USDOL is not allowed. Please use DOL or other tokens as an intermediary",
    prohibitedPairTitle: "Trading Restriction",
    sure: "Confirm",
